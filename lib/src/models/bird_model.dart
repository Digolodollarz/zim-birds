...
class Bird {
  ...
  factory Bird.fromJson(Map<String, dynamic> json) => Bird(
    ...
    recordings: json["recordings"] == null ? null : List<Recording>.from(json["recordings"].map((x) => Recording.fromJson(x))),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "recordings": recordings == null ? null : List<dynamic>.from(recordings!.map((x) => x.toJson())),
  };
}
...
class Recording {
  ...
  factory Recording.fromJson(Map<String, dynamic> json) => Recording(
    ...
    uploaded: json["uploaded"] == null ? null : DateTime.parse(json["uploaded"]),
    also: json["also"] == null ? null : List<String>.from(json["also"].map((x) => x)),
    rmk: json["rmk"] == null ? null : json["rmk"],
    birdSeen: json["bird-seen"] == null ? null : json["bird-seen"],
    playbackUsed: json["playback-used"] == null ? null : json["playback-used"],
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "uploaded": uploaded == null ? null : "${uploaded!.year.toString().padLeft(4, '0')}-${uploaded!.month.toString().padLeft(2, '0')}-${uploaded!.day.toString().padLeft(2, '0')}",
